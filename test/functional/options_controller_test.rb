...
class OptionsControllerTest < ActionController::TestCase
  ...
  test "should create option" do
    assert_difference('Option.count') do
      post :create, option: { answer: @option.answer, inference: @option.inference, option_id: @option.option_id, question: @option.question }
    end
  ...
  test "should update option" do
    put :update, id: @option, option: { answer: @option.answer, inference: @option.inference, option_id: @option.option_id, question: @option.question }
    assert_redirected_to option_path(assigns(:option))
  end
